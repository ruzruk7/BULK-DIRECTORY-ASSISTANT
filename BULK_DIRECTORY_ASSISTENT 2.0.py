    ...
    if file_mode:
        while True:
            ...
            if mode =='mm':
                ...
                if sec_sub_mode == 'all':
                    tert_sub_mode = input('Delete all files from single or multiple folders?\nSingle Folder: SFOL\tMultiple Folder: MFOL\nEntered: ').lower()
                    ...
                    if tert_sub_mode == 'sfol':
                        ...
                        file_names = []
                        file_name = input('Plese enter the file names(case-sensitive), if there are multiple file names that are numbered differently (e.g: file_1, file_2...file_300).\nEnter only part of the file name(e.g: \'file_\') seperated by commas WITHOUT spaces.\nEntered: ')
                        splitted = file_name.split(',')
                        for split in splitted:
                            file_names.append(split)
                        print(f'Folders specified---{folder_names}---')
                        print(f'File names---{file_names}---\n')
                        file_destination_root_folder = input('Please enter the PATH of the parent folder containing the folders specified\ne.g: User/Desktop/Folder_of_interest  | you would enter: User/Desktop.\nEntered: ')
                        print('')
                        formatted_dest = path_formatter(file_destination_root_folder)
                        for folder in folder_names:
                            folder_path = (f'{formatted_dest}\\{folder}')
                ...
                if sub_mode == 'all':
                    ...
                    if sec_sub_mode == 'sfol':
                        # origin
                        file_parent_folder_location = input('Please enter file(s) origin folder location as a PATH(case-sensitive).\nEntered: ')
                        print('')
                        formatted_orig = path_formatter(file_parent_folder_location)
                        # destination
                    ...
                    if sec_sub_mode == 'sfol':
                        ...
                        for split in splitted:
                            file_name_types.append(split)
                        print(f'File names---{file_name_types}---\n')
                        file_parent_folder_location = input('Please enter file(s) origin folder PATH(case-sensitive).\nEntered: ')
                        print('')
                        formatted_orig = path_formatter(file_parent_folder_location)
                        # destination
                        file_destination = input('Please enter the PATH(case-sensitive) you want your FILES moved to.\nEntered: ')
                        ...
                        #origin
                        file_parent_folder_location = input('Please enter file(s) original folder PATH(case-sensitive).\nEntered: ')
                        print('')
                        formatted_orig = path_formatter(file_parent_folder_location)
                        # destination
                ...
                if sub_mode == 'all':
                    ...
                    if sec_sub_mode == 'sfol':
                        # origin
                        file_parent_folder_location = input('Please enter origin file(s) folder location as a PATH.\nEntered: ')
                        print('')
                        formatted_orig = path_formatter(file_parent_folder_location)
                        # destination
                    ...
                    sec_sub_mode = input('Would you like to move specific files to a single or multiple folders?\nSINGLE folder enter: SFOL\tMULTIPLE folders enter: MFOL\nEntered: ').lower()
                    if sec_sub_mode == 'sfol':
                        file_names = []
                        ...
                        # origin
                        file_parent_folder_location = input('Please enter original file(s) folder PATH(case-sensitive).\nEntered: ')
                        print('')
                        formatted_orig = path_formatter(file_parent_folder_location)
                        # destination
                        file_destination = input('Please enter the PATH(case-sensitive) of the folder you want your FILES moved to.\nEntered: ')
                        ...
                        formatted_orig = path_formatter(file_parent_folder_location)
                        # destination
                        file_destination_root_folder = input('Please enter the PATH(case-sensitive) of the parent folder which contains the folders you want your specified files copied to.\ne.g: User/Desktop/Folder_of_interest  | you would enter: User/Desktop.\nEntered: ')
                        print('')
                        formatted_dest = path_formatter(file_destination_root_folder)
                        all_files_in_orig = os.listdir(formatted_orig)
                        for folder in folder_names:
